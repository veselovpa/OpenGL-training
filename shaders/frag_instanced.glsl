...
//void main()
//{    
//    vec3 color_light = vec3(1.0f, 1.0f, 1.0f);
//
...
//    float spec = 0.0f;
//    vec3 halfwayDir = normalize(lightDir + viewDir);
//    spec = pow(max(dot(norm, halfwayDir), 0.0), mat.shininess/3);
//
//    vec3 result = color_light * (mat.diffuse_color * diff + mat.specular_color * spec);
//
//    if (mat.tex == 1)
//    {
//        outColor = texture(texture_diff, vTexCoords) * vec4(result, 1.0f);
//    }
//    else 
//    {
//        outColor = vec4(result, 1.0f);
